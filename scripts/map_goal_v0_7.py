...
def main():
 ...
 P=json.loads((a.v06_dir/'independent_statement_profiles.json').read_text());G=json.loads((a.v06_dir/'mapeogeo_independent_graph.json').read_text());R6=json.loads((a.v06_dir/'independent_dual_view_report.json').read_text())
