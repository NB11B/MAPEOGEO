...
def main() -> int:
    ...
    report=json.loads((a.artifact_dir/"corpus_dualization_report.json").read_text())
    profiles=json.loads((a.artifact_dir/"semantic_profiles.json").read_text())
    graph=json.loads((a.artifact_dir/"mapeogeo_corpus_graph.json").read_text())
